    ...
    return (
        ...
        <div>
            ...
            <div>
                ...
                <div className="tbox">
                    <h4>StudentStay  · <div className="tool">React</div><div className="tool">Firebase</div><div className="tool">Tailwind</div><div className="tool">Figma</div><div className="tool">Jira</div></h4>
                ...
                <div className="tbox">
                    <h4>mayapaint.studio (<a href="https://mayapaint-mayasundar.vercel.app/" target="_blank" rel="noopener noreferrer">website</a>) · <div className="tool">React Native</div></h4>
