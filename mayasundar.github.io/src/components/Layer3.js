        ...
        <div className="tab-content-container">
            <div className="tab-content">
                ...
                <ul>
                    ...
                    <li>I've interned at three MBA student-run ventures at
                        <a href="https://columbiabuildlab.com/" target="_blank" rel="noopener noreferrer"> Columbia Build Lab</a>, an incubator housed at Columbia Business School.
                    ...
                    <li>During college, I worked on research at Teachers College and Columbia University
                        Irving Medical Center and have learned a lot about knowledge diversity
                        and structural variant gene annotation, respectively.</li>
                </ul>
            </div>
        </div>
    );
