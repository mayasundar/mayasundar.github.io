...
const IndexPage = () => {
    ...
    <div>
      ...
      <p>
          ...
          <br />
          <br />
          In my free time, I enjoy crossword puzzles, <a className="paint">painting</a>, and reading short stories.
      </p>
      ...
      <h2>Contact Me</h2>
        ...
        <div class="social-icon">
          <a class="social" href="https://www.linkedin.com/in/mayasundar">
          ...
          <a class="social" href="https://github.com/mayasundar">
              <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 24 24">
      ...
      <h2>Writing
        ...
        <a className="box" href="/blog/on-digital-humanities">
            ...
            June 2021</div>
            <div className="title">
            On Digital Humanities</div>
        </a>
        <a className="box" href="x.html">
            <div className="date">
            April 2021</div>
            <div className="title">
            Public Roads, Private Profit</div>
        </a>
        <a className="box" href="x.html">
            <div className="date">
            March 2021</div>
            <div className="title">
            Decentralized Dystopia</div>
        </a>
